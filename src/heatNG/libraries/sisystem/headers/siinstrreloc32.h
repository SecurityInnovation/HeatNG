...
{
	writeDWord(dest,(WORD)(n&0xfffffffful));
	writeDWord(dest,(WORD)((n>>32)&0xfffffffful));
}
...
IS PBYTE copyNextOpcode(PBYTE dest, PBYTE src, PBYTE* updatedSrcPtr, int addrSize=32, int opSize=32, BOOL twoByteOp=false)
{
